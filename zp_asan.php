<?php
	...
	$CallbackURL = $systemUrl . '/modules/gateways/callback/zp_asan.php?invoiceid='. $_POST['invoiceid'] .'&Amount='. $Amount;
	try {
	...
	if($result->Status == 100){ 
		...
		$url = "https://$mirror.zarinpal.com/pg/StartPay/$vahabid/Asan";
		redirect($url);
	} else {
